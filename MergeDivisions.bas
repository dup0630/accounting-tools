Sub MergeGuillevinBrogan()
    ...
    Sheet1.ListObjects("TABLE").ListColumns("Branch").DataBodyRange.Formula = "=IFNA(VLOOKUP([@[Inv. number]],DCSTR, 3, FALSE), IFNA(VLOOKUP([@[Inv. number]],DCSTRBRGN, 3, FALSE), VLOOKUP([@[Inv. number]],DCSTRDUBO, 3, FALSE)))"
